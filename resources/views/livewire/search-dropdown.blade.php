<div class="relative mt-3 md:mt-8" x-data="{ isOpen: true }" @click.away="isOpen = false">
    <input wire:model.live="search" type="text"
        ...
        name="" id="" placeholder="Search...." x-ref="search"
        @keydown.window="
    ...
    <div class="absolute top-0">
        <svg xmlns="http://www.w3.org/2000/svg" class="fill-current w-4 mt-2 ml-2 text-gray-500" viewBox="0 0 50 50">
            <path
    ...
    <div wire:loading class="absolute top-0 right-0 mr-4 mt-1">
